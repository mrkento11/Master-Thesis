...
%             end
            ...
            if Feasibility ~= 0         % If one or more of the previous UCP are not feasible, we will increase the amount of reserve, to try to make them feasible within the next iterations. 
                ...
                sOR(t) = sOR(t) + 0.1;        % SUGGESTION: Device a way to find the optimal amount of reserve. Maybe after it becomes feasible, apply a bisection method to find the best sOR within a given 1%. Perhaps for the next while, apply the same logic, but in increments of 1%.
                Feasibility = 0;
                break;                  % We break the scenarios for loop
            end
    ...
    %% Attempt to exist For loop
    if Global_Feasibility == 0
